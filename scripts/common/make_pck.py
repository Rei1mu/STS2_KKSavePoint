...
def generate_import_artifacts(godot_exe: str, mod_name: str, source_image: Path) -> tuple[Path, Path, str] | None:
    with tempfile.TemporaryDirectory() as temp_dir_raw:
        ...
        stable_root = Path(tempfile.mkdtemp(prefix="examplemod_import_"))
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pack ExampleMod.pck")
    ...
    mod_name = os.environ.get("MOD_BASENAME", "ExampleMod")
